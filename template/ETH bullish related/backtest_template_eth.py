...
def main():
    ...
    os.chdir("/Users/mig/Documents/LSE/Capstone Project/lse-bitcoin-analytics-capstone-template/template/ETH bullish related")
    ...
    output_dir = base_dir / "output ETH bullish"
