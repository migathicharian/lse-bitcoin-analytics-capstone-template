...
try:
    from template.model_development_template_fed_rate import compute_window_weights, precompute_features
    from template.prelude_template_fed_rate import (
    ...
    from model_development_template_fed_rate import compute_window_weights, precompute_features
    from prelude_template_fed_rate import (
        backtest_dynamic_dca,
        check_strategy_submission_ready,
        load_data,
        parse_window_dates,
