...
try:
    from template.model_development_template_fed_rate import (
        compute_window_weights,
        precompute_features,
    )
    import template.model_development_template_fed_rate as model_module
    from template.prelude_template_fed_rate import backtest_dynamic_dca, load_data
except ImportError:
    from model_development_template_fed_rate import (
        compute_window_weights,
        precompute_features,
    )
    import model_development_template_fed_rate as model_module
    from prelude_template_fed_rate import backtest_dynamic_dca, load_data
...
os.chdir(
    "/Users/mig/Documents/LSE/Capstone Project/"
    "lse-bitcoin-analytics-capstone-template/template/fed rate"
)
...
for strength in STRENGTHS_TO_TEST:
    ...
    features_df = precompute_features(btc_df, fed_signal)
