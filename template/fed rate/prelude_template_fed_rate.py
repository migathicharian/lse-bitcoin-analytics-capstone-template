...
try:
    from template.model_development_template_fed_rate import precompute_features
except ImportError:
    from model_development_template_fed_rate import precompute_features
...
def compute_cycle_spd(
    ...
    if features_df is None:
        full_feat = precompute_features(dataframe, fed_signal['fed_signal']).loc[start:end]
    else:
